...
\usepackage[
    title={
Integrating OAuth into Gropius
},
    author={Nils Boike, Johannes Zipfel, Cara Heck},
    type=masterresearchprojectproposal,
%    type=masterproposal,
%    type=phdproposal,
    institute=isterss,
    number=12345,
...
%    course=drrernat,
	...
	supervisor={Sandro Speth,\ M.Sc.}, % uncomment and comment the relevant primary supervisor and add additional supervisors in behind.
 	% supervisor={Niklas Mei{\ss}ner,\ M.Sc.},
   	% supervisor={Patrick Spaney,\ M.Sc.},
     	% supervisor={Sarah Stie{\ss},\ M.Sc.},
       	% supervisor={Miles St{\"o}tzner,\ M.Sc.},
 	% supervisor={Marcel Weller,\ M.Sc.},
   	% supervisor={Nadine Koch,\ M.Sc.},
